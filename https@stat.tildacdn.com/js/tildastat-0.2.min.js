...
if(p>=10&&!isSendScrollEvent.p10){tildaParams.page='tilda/scroll/10/default.htm';w.tildastat('pageview');isSendScrollEvent.p10=!0}else{if(p>=24){if(isSendScrollEvent.p25==0){tildaParams.page='tilda/scroll/25/default.htm';w.tildastat('pageview');isSendScrollEvent.p25=w.setTimeout(function(){w.clearTimeout(isSendScrollEvent.p25);isSendScrollEvent.p25=-1},5000);return}else{if(p<51&&isSendScrollEvent.p25==-1){isSendScrollEvent.p25=0;return}}}
if(p>=49){if(isSendScrollEvent.p50==0){tildaParams.page='tilda/scroll/50/default.htm';w.tildastat('pageview');isSendScrollEvent.p50=w.setTimeout(function(){w.clearTimeout(isSendScrollEvent.p50);isSendScrollEvent.p50=-1},5000);return}else{if(p<76&&isSendScrollEvent.p50==-1){isSendScrollEvent.p50=0;return}}}
if(p>=74){if(isSendScrollEvent.p75==0){tildaParams.page='tilda/scroll/75/default.htm';w.tildastat('pageview');isSendScrollEvent.p75=w.setTimeout(function(){w.clearTimeout(isSendScrollEvent.p75);isSendScrollEvent.p75=-1},5000);return}else{if(p<91&&isSendScrollEvent.p75==-1){isSendScrollEvent.p75=0;return}}}
if(p>=89){if(isSendScrollEvent.p90==0){tildaParams.page='tilda/scroll/90/default.htm';w.tildastat('pageview');isSendScrollEvent.p90=w.setTimeout(function(){w.clearTimeout(isSendScrollEvent.p90);isSendScrollEvent.p90=-1},5000);return}else{if(isSendScrollEvent.p90==-1){isSendScrollEvent.p90=0;return}}}}};w.tildastat=function(event,params){var staturl='https:'+'//stat'+'.tildacdn.'+'com/event/';if(!event){return!1}
...
setCookie('tildauid',userid,{expires:expiriesDate,path:'default.htm'});setCookie('tildasid',sessionid,{expires:1800,path:'default.htm'});if(w.tildastatscroll=='yes'){try{w.onVisibilityWindowChange(function(visible){isWindowActive=(visible?!0:!1)});$('body').on('mousewheel, mousemove',t_throttle(function(){isWindowActive=!0},1000));$('body').on('keypress',t_throttle(function(){isWindowActive=!0},1000));$('body').on('click',t_throttle(function(){isWindowActive=!0},1000))}catch(e){}}
...
sessid=getCookie('tildasid')||'';if(sessid!=tildaParams.sessionid){setCookie('tildasid',tildaParams.sessionid,{expires:1800,path:'default.htm'})}
